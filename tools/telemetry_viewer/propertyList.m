classdef propertyList
    ...
    props = [propertyEntry('launch hopper',        'uint8',   0,  1,  'W', 'C',     [0], [""]),...
             propertyEntry('kill edf',             'uint8',   1,  1,  'W', 'C',     [0], [""]),...
             propertyEntry('reset system',         'uint8',  30,  1,  'W', 'C',     [0], [""]),...
             propertyEntry('hopper flight status', 'uint32',  2,  4,  'R', 'S',     [1], ["status:"]),...
             propertyEntry('target position',      'float',  41, 12, 'RW', 'V',     [3], ["xpos:", "ypos:", "zpos:"]),...
             propertyEntry('battery voltage',      'float',  18,  4,  'R', 'V',     [1], ["volts:"]),...
             propertyEntry('servo positions',      'float',  40, 16, 'RW', 'V',     [4], ["servo 1:","servo 2:","servo 3:","servo 4:"]), ...
             propertyEntry('raw lidar',            'uint32', 50,  4,  'R', 'V',     [1], ["altitude"]),...
             propertyEntry('raw Imu',              'float',  51, 40,  'R', 'V', [3 3 4], ["accX", "accY", "accZ", "gyroX", "gyroY", "gyroZ", "?", "?", "?", "?"])...
