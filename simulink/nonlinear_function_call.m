...
switch flag
  ...
  %%%%%%%%%%%%%%%%%%
  case 0
    % -CHANGED for C code generation-
%     s = struct('NumContStates', 12, 'NumDiscStates', 0, 'NumOutputs', 12, 'NumInputs', 5, 'DirFeedthrough', 0, 'NumSampleTimes', 1);
    s = simsizes;
    ...
    sys = simsizes(s);  % Initial system -CHANGED for C code generation-
%     sys = s;
